...
<div class="right">
    ...
    <div class="providerView">
        ...
        <img class="movieImg" src="${schedule.getMovie_ImageSrcByMovie_ID().substring(3,schedule.getMovie_ImageSrcByMovie_ID().toString().length()) }">
        <a class="addSchedule" style="padding: 10px;margin: 10px;width:50px;height:30px;float: right;" href="login.jsp"}>订票</a>
...
<script type="text/javascript" src="${pageContext.request.contextPath }/scheduleview.js"></script>
