...
<%@include file="/jsp/common/head.jsp"%>
    <div class="right">
        ...
        <form id="userForm" name="userForm" method="post" action="${pageContext.request.contextPath }/jsp/customer.do">
...
<script type="text/javascript" src="${pageContext.request.contextPath }/js/cu_customermodify.js"></script>
