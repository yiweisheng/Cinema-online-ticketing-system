...
$(function(){
	$(".viewProvider").on("click",function(){
		...
		var obj = $(this);
		window.location.href=path+"/jsp/admin/movie.do?method=view&movieid="+ obj.attr("movieid");
	});
	
	$(".modifyProvider").on("click",function(){
		var obj = $(this);
		window.location.href=path+"/jsp/admin/movie.do?method=modify&movieid="+ obj.attr("movieid");
	});
