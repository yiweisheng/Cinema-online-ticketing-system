...
$(function(){
	...
	$(".viewUser").on("click",function(){
		...
		var obj = $(this);
		window.location.href=path+"/jsp/admin/order.do?method=view&order_ID="+ obj.attr("Order_ID");
	});
	
	$(".modifyUser").on("click",function(){
		var obj = $(this);
		window.location.href=path+"/jsp/admin/order.do?method=modify&order_ID="+ obj.attr("Order_ID");
	});
