...
$(function(){
	...
	$(".viewUser").on("click",function(){
		...
		var obj = $(this);
		window.location.href=path+"/schedule.do?method=view&schedule_ID="+ obj.attr("Schedule_ID");
	});
	
	$(".modifyUser").on("click",function(){
		var obj = $(this);
		window.location.href=path+"/schedule.do?method=modify&schedule_ID="+ obj.attr("Schedule_ID");
	});
