...
<style type="text/css">
	...
	border-radius: 4px;
        ...
        <div class="right">
            ...
            <div class="search">
           		<form method="get" action="${pageContext.request.contextPath }/schedule.do">
...
<script type="text/javascript" src="${pageContext.request.contextPath }/schedulelist.js"></script>
