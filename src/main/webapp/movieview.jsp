...
<%@include file="/head.jsp"%>
 <div class="right">
        ...
        <div class="providerView">
            ...
            <img class="movieImg" src="${movie.getMovie_ImageSrc().substring(3,movie.getMovie_ImageSrc().toString().length())}">
...
<script type="text/javascript" src="${pageContext.request.contextPath }/movieview.js"></script>
