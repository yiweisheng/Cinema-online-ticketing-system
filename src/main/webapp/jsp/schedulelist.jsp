...
<style type="text/css">
	...
	border-radius: 4px;
        ...
        <div class="right">
            ...
            <div class="search">
           		<form method="get" action="${pageContext.request.contextPath }/jsp/schedule.do">
					...
					<span>电影名：</span>
					<input name="Movie_Name" class="input-text"	ype="text" value="${Movie_Name }">
...
<%--					 <a href="${pageContext.request.contextPath}/jsp/scheduleadd.jsp" >添加时间表</a>--%>
				</form>
            </div>
            <!--用户-->
...
<script type="text/javascript" src="${pageContext.request.contextPath }/js/schedulelist.js"></script>
