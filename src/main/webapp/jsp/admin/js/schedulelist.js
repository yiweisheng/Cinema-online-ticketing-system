...
function deleteUser(obj){
	$.ajax({
		type:"GET",
		url:path+"/jsp/admin/schedule.do",
...
$(function(){
	...
	$(".viewUser").on("click",function(){
		...
		var obj = $(this);
		window.location.href=path+"/jsp/admin/schedule.do?method=view&schedule_ID="+ obj.attr("Schedule_ID");
	});
	
	$(".modifyUser").on("click",function(){
		var obj = $(this);
		window.location.href=path+"/jsp/admin/schedule.do?method=modify&schedule_ID="+ obj.attr("Schedule_ID");
	});
